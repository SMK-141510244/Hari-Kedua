	...
	<table class="table table-striped table-bordered table-hover">
		...
		<tbody>
			...
			<tr>
				...
				<td> {{ $gajian->Jumlah_jam_lembur->Tunjangan_pegawai->Pegawai->Lembur_pegawai->Jumlah_jam}} </td>
				<td> {{ $gajian->Jumlah_uang_lembur->Tunjangan_pegawai->Pegawai->Lembur_pegawai->Besaran_uang}}</td>
